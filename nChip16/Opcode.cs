...
namespace nChip16
{
    internal class Opcode
    {
        ...
        private static readonly List<byte> LLHH_Group = new List<byte>
            ...
            0x40,0x50,0x53,0x60,0x63,0x70,0x80,0x90,0xA0,0xD0};
        private static readonly List<byte> YX_Group = new List<byte>
            {0x05,0x06,0x13,0x23,0x24,0x31,0x41,0x42,0x51,0x52,0x54,0x61,0x62,0x64,0x71,0x72,
            0x81,0x82,0x91,0x92,0xA1,0xA2,0xB3,0xB4,0xB5,};
        ...
        private static readonly List<byte> YXZ_Group = new List<byte>
            {0x06,0x42,0x52,0x62,0x72,0x82,0x92,0xA2};
