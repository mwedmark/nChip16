...
UpdateTimerBcd:
	push R0
	push R1		; pushing R0,R1 to be able to reuse byteaccess.asm
	ldm  R2, Time
	andi R2, 0xF
	muli R2, 4 ; select offset for correct BCD values
	addi R2, BCDTable ; add base address of BCDTable
	ldm  R3, R2 ; read BCD3
	andi R3, 0xFF
	addi R2, 1
	ldm  R4, R2 ; read BCD2
...
importbin C:\Share\Chip16\tchip16_1.4.5\Mario\Mario16CRW.bmp.bin 0 5251 TileSet
importbin C:\Share\Chip16\tchip16_1.4.5\Mario\MarioFontLong.bmp.bin 0 1539 MarioFont
importbin C:\Share\Chip16\tchip16_1.4.5\Mario\Mario16CRW.bmp.PAL 0 48 Palette
StartTiles:
...
StartOSD:
db 0x0A,0x1C,0x10,0x21,0x18,0x1E,0x0A,0x0A,0x0A,0x1B,0x18,0x25,0x14,0x22,0x0A,0x0A,0x0A,0x0A,0x0A,0x0A,0x0A,0x0A,0x0A,0x0A,0x0A,0x0A,0x26,0x1E,0x21,0x1B,0x13,0x0A,0x0A,0x0A,0x0A,0x23,0x18,0x1C,0x14,0x0A,
db 0x0A,0x00,0x00,0x00,0x00,0x00,0x00,0x0A,0x0A,0x0A,0x0A,0x00,0x03,0x0A,0x0A,0x0A,0x0A,0x0A,0x00,0x0C,0x02,0x0A,0x0A,0x0A,0x0A,0x0A,0x0A,0x01,0x0D,0x01,0x0A,0x0A,0x0A,0x0A,0x0A,0x0A,0x0F,0x0F,0x0F,0x0A,
EndOSD:
;importbin C:\Projects\nChip16\CreateImportBinForPics\bin\Debug\Flag_of_Germany.bmp.cci 0 71 Picture

BCDTable: ; handles number between 0-1023
; BCD0 - 0-15
